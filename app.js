...
// تكملة مصفوفة النماذج القانونية (إضافة نماذج الطلاق والفسخ)
const divorceTemplates = {
    // 1. طلاق للضرر والشقاق
    'fam_z_harm': {
        title: "دعوى تطليق للضرر والشقاق",
        courtType: "قاضي محكمة الأحوال الشخصية",
        body: "1/ المدعية زوجة شرعية للمدعى عليه بصحيح العقد الشرعي.\n2/ تضرر المدعية من المدعى عليه ضرراً يتعذر معه دوام العشرة (تذكر أنواع الضرر: ضرب، إساءة، هجر).\n3/ عجز الأجاويد عن الإصلاح بينهما، وحيث أن إمساك بمعروف أو تسريح بإحسان.",
        requests: "الحكم للمدعية بالتطليق للضرر والشقاق بطلقة بائنة للضرر."
    },

    // 2. طلاق للإعسار عن النفقة
    'fam_z_poverty': {
        title: "دعوى تطليق للإعسار عن النفقة",
        courtType: "قاضي محكمة الأحوال الشخصية",
        body: "1/ المدعية زوجة شرعية للمدعى عليه.\n2/ المدعى عليه عجز عن الإنفاق على المدعية لفقره وإعساره، وقد صبرت عليه طويلاً ولم يستطع القيام بواجب النفقة.\n3/ المدعية تخشى على نفسها الفتنة والضياع.",
        requests: "الحكم للمدعية بالتطليق لإعسار المدعى عليه عن النفقة."
    },

    // 3. طلاق للعيب (العلل والجنون)
    'fam_z_defect': {
        title: "دعوى تطليق للعيب المستحكم",
        courtType: "قاضي محكمة الأحوال الشخصية",
        body: "1/ المدعية زوجة شرعية للمدعى عليه.\n2/ وجد بالمدعى عليه عيباً مستحكماً (تذكر العيب: علة جنسية، مرض معدي، جنون) لا يمكن معه دوام العشرة ولا يرجى منه برء، ولم تكن المدعية تعلم به وقت العقد.",
        requests: "الحكم بالتطليق للعلة والعيب بطلقة بائنة."
    },

    // 4. طلاق للغيبة أو الحبس
    'fam_z_absence': {
        title: "دعوى تطليق للغيبة (أو للحبس)",
        courtType: "قاضي محكمة الأحوال الشخصية",
        body: "1/ المدعية زوجة شرعية للمدعى عليه.\n2/ غاب المدعى عليه عن المدعية لمدة تزيد عن السنة في مكان (تذكر المكان) دون عذر مقبول، مما ألحق بها ضرراً بليغاً وتخشى على نفسها العنت.",
        requests: "الحكم بتطليق المدعية للغيبة والضرر."
    },

    // 5. طلاق للفدية (الخلع)
    'fam_z_khula': {
        title: "دعوى تطليق للفدية (إبراء)",
        courtType: "قاضي محكمة الأحوال الشخصية",
        body: "1/ المدعية زوجة شرعية للمدعى عليه.\n2/ المدعية تبغض الحياة مع المدعى عليه وتخشى ألا تقيم حدود الله معه، وهي مستعدة لافتداء نفسها بالتنازل عن حقوقها الشرعية (المهر والمؤخر).",
        requests: "الحكم بتطليق المدعية للفدية (بطلقة بائنة خلعاً)."
    },
    ...
    'fam_z_obey': {
        title: "دعوى طاعة",
        courtType: "قاضي محكمة الأحوال الشخصية",
        body: "1/ المدعى عليها زوجة شرعية للمدعي وفي عصمته.\n2/ المدعي هيأ للمدعى عليها مسكناً شرعياً لائقاً وأوفاها معجل مهرها وهو مأمون عليها في نفسها ومالها.\n3/ خرجت المدعى عليها من منزل الزوجية دون إذن أو مبرر ورفضت العودة.",
        requests: "الحكم بدخول المدعى عليها في طاعة المدعي."
    },

    // 7. رؤية واصطحاب محضون
    'fam_h_view': {
        title: "دعوى رؤية واصطحاب محضون",
        courtType: "قاضي محكمة الأحوال الشخصية",
        body: "1/ المدعي كان زوجاً للمدعى عليها وله منها الأبناء (........).\n2/ الأبناء بِيَد المدعى عليها للحضانة، وهي تمنع المدعي من رؤيتهم وقضاء الوقت معهم دون وجه حق.",
        requests: "الحكم للمدعي برؤية أبنائه واصطحابهم في الأوقات التي تحددها المحكمة."
    }
};

// ملاحظة للمبرمج: يتم دمج هذه الكائنات داخل متغير legalTemplates الرئيسي في الملف
Object.assign(legalTemplates, divorceTemplates);
